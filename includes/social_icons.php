...
<?php if ( 'on' === et_get_option( 'divi_show_youtube_icon', 'on' ) ) : ?>
    <li class="et-social-icon et-social-youtube">
        <a target="_blank" href="<?php echo esc_url( et_get_option( 'divi_youtube_url', 'https://www.youtube.com/channel/UC2I7EDTNeI2CoyUT7WKUDOA/featured?view_as=subscriber' ) ); ?>" class="icon">
...
<?php if ( 'on' === et_get_option( 'divi_show_flikr_icon', 'on' ) ) : ?>
    <li class="et-social-icon et-social-flikr">
        <a target="_blank" href="<?php echo esc_url( et_get_option( 'divi_flikr_url', 'https://www.flickr.com/photos/upsontg/sets/72157706567921801/' ) ); ?>" class="icon">
